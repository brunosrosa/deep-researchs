...
2. **Exclusão Mútua de VRAM:** O Tier 1 (`Qwen2.5-Coder` na dGPU) e o Tier 2 (MoE assíncrono) **nunca coexistem na VRAM**. Se o Tier 2 for acionado, o Tier 1 deve ser descarregado ou o Tier 2 deve ser desviado para a CPU Intel i9 com instruções AVX2.
