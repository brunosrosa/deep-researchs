...
A interface deve ser projetada para ser "Compute-Aware". Antecipe onde haverá processamento assíncrono e inclua padrões visuais como _Skeleton Loading_ reativo e _Streaming Text_. Projete os componentes pensando em micro-interações mecânicas (50ms) para botões e transições fluidas e orgânicas (250ms) para navegação de painéis.
